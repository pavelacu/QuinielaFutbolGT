...
function _pronostico_puntaje() {
    ...
    $db->setSql(FactoryDao::getMatchesVrsReal($rondaID, Security::getUserID()));
    $db->executeQuery();

    $data['siteTitle'] = Security::getSessionVar("TITTLE") . 'Mi Quiniela';
    $data['body'][] = View::do_fetch(VIEW_PATH . 'main/form_real.php', array("partidos" => $db, "ronda" => $rondaName, "fecha" => $fechaActual));
